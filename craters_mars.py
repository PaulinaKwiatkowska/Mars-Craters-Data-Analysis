...
print 'mean:',source['LONGITUDE_CIRCLE_IMAGE'].mean()
print 'standard deviation:',source['LONGITUDE_CIRCLE_IMAGE'].std()
...
print 'mean:',source['LATITUDE_CIRCLE_IMAGE'].mean()
print 'standard deviation:',source['LATITUDE_CIRCLE_IMAGE'].std()